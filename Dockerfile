...
RUN yum -y install https://centos7.iuscommunity.org/ius-release.rpm && \ 
        yum -y install git nmap-ncat net-tools python35u dos2unix python35u-pip httpd  readline python35u-devel gcc-c++ gcc gcc-gfortran python34-devel openldap-devel && \
